...
(function (root) {
  var P = {
    ...
    /* pantry glyphs — sealed goods carry a mark instead of a photograph */
    sack:        '<path d="M8.5 3.5h7l-1 2.6c2.6 1.5 4.5 4.2 4.5 7.4 0 4-3.1 6.5-7 6.5s-7-2.5-7-6.5c0-3.2 1.9-5.9 4.5-7.4l-1-2.6Z"/><path d="M9.5 13.5h5"/>',
    bottle:      '<path d="M10 3.5h4v3l2.2 2.6a4 4 0 0 1 .9 2.5v7.9a1 1 0 0 1-1 1H7.9a1 1 0 0 1-1-1v-7.9a4 4 0 0 1 .9-2.5L10 6.5v-3Z"/><path d="M7 14h10"/>',
    tin:         '<ellipse cx="12" cy="6.2" rx="6" ry="2.4"/><path d="M6 6.2v11.6c0 1.3 2.7 2.4 6 2.4s6-1.1 6-2.4V6.2"/><path d="M6 12c0 1.3 2.7 2.4 6 2.4s6-1.1 6-2.4"/>',
    sachet:      '<path d="M6.2 5h11.6l-1 14a1 1 0 0 1-1 .9H8.2a1 1 0 0 1-1-.9L6.2 5Z"/><path d="M6.6 8.6h10.8"/><path d="M8.6 5V3.4h6.8V5"/>',
    crate:       '<rect x="3.5" y="7.5" width="17" height="12" rx="1.4"/><path d="M3.5 11.5h17M3.5 15.5h17M9 7.5v12M15 7.5v12"/>',
    egg:         '<path d="M12 3.6c3.2 0 5.6 4.8 5.6 8.6a5.6 5.6 0 0 1-11.2 0c0-3.8 2.4-8.6 5.6-8.6Z"/>',
    bread:       '<path d="M4 10.5a3.4 3.4 0 0 1 3.4-3.4h9.2A3.4 3.4 0 0 1 20 10.5v7.6a1.4 1.4 0 0 1-1.4 1.4H5.4A1.4 1.4 0 0 1 4 18.1v-7.6Z"/><path d="M8.6 7.1v12.4M13.4 7.1v12.4"/>',
    salt:        '<path d="M8 9.5h8l1.1 9.4a1.3 1.3 0 0 1-1.3 1.5H8.2a1.3 1.3 0 0 1-1.3-1.5L8 9.5Z"/><path d="M9.4 9.5V7a2.6 2.6 0 0 1 5.2 0v2.5"/><path d="M11 4.4v.9M13 4.4v.9"/>',
    noodle:      '<path d="M4.5 12h15a7.5 7.5 0 0 1-15 0Z"/><path d="M6.5 12c0-2.6 1.2-4.4 2.6-5.6M12 12c0-3 .8-5 2-6.4M17.2 12c-.2-2.2-.9-3.6-1.8-4.6"/>'
  };
